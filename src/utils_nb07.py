...
PARAMETER_SCHEMA = {
    ...
    "step_05": {
        ...
        "parameters": {
            ...
            "subject_context.height_cm": {"type": "float", "section": "S0", "description": "Subject height from registry or ratio-corrected mocap estimate. Formula: $h = (Head_Y - Floor_Y) / r$ where $r$ = head_to_floor_stature_ratio (default 0.87, de Leva 1996). Corrects for missing crown and sole segments. Cross-validated against registry within 5%."},
            ...
            "subject_context.height_status": {"type": "str", "section": "S0", "description": "Height validation result: PASS (within 5% of registry), REVIEW (5-15% deviation), FAIL (>15% or impossible value). Catches unit errors, non-upright reference, or wrong subject association"},
...
METHODOLOGY_PASSPORT = {
    ...
    "filtering": {
        ...
        "stage3_adaptive_winter": {
            ...
            "strategy": "Per-Region Adaptive Cutoff Selection (Dynamic RMS Windowing)",
            "fmin_hz": 1.0,
            "fmax_hz": 20.0,
            "regions": {
                "head": "Head markers",
            ...
            "filter_order": 2,
            "implementation": "Zero-lag (chunked filtfilt) - forward-backward pass, NaN-safe chunking guard",
    ...
    "resampling": {
        ...
        "positions_method": "PCHIP (single-pass)",
