...
| Check | Required |
|-------|----------|
| Artifact fraction uses OR-union | PASS |
| Reference threshold = 0.20 | PASS |
| S02 labels corrected | PASS |
| Interpolation stats logged | PASS |
| Hips excluded from ATF_axial | PASS |
| ATF_axial change documented | PASS |
| Golden parquet regression: Tier 2 | PASS |
